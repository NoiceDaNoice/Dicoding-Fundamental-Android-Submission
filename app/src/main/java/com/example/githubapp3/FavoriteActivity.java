...
import com.example.githubapp3.adapter.FavoriteAdapter;
import com.example.githubapp3.db.DatabaseContract;
import com.example.githubapp3.helper.MappingHelper;
...
public class FavoriteActivity extends AppCompatActivity implements LoadNotesCallback {
    ...
    private void showSnackbarMessage() {
        Snackbar.make(rvFavorite, "No Data", Snackbar.LENGTH_SHORT).show();
    }
